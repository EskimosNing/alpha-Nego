EXP_NAME="fixed_uttr_id_history_tom_7"
...
--learning-rate 0.001 --name ${EXP_NAME} --load-identity-from checkpoint/uttr_id_7/model_best.pt \
--tom-hidden-size 128 --tom-hidden-depth 2 --id-hidden-size 128 --id-hidden-depth 2 \
--fix-id --strategy-in-words --tom-model ${MODEL_NAME} ${USE_GPU}